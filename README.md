...
- [`DECISIONES.md`](./DECISIONES.md) — por qué el código hace las cosas como las hace.
- [`LENGUA.md`](./LENGUA.md) — qué puede afirmar esta aplicación sobre el ckunsa y qué no.
- [`DATOS.md`](./DATOS.md) — de dónde sale cada dato y bajo qué condiciones.
- [`LICENSES.md`](./LICENSES.md) — qué es de quién.
